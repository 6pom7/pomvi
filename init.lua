...
require('lazy').setup({
 ...
 { -- Fuzzy Finder (files, lsp, etc)
  ...
  config = function()
   ...
   -- vim.keymap.set('n', '<leader>sf', builtin.find_files({ cwd = utils.buffer_dir() }) end, { desc = '[S]earch [F]iles' })
  ...
  config = function()
   ...
   vim.api.nvim_create_autocmd('LspAttach', {
    ...
    callback = function(event)
     ...
     map('<leader>ci', require('telescope.builtin').lsp_implementations, 'Goto [C]ode [I]mplementation')

     -- Jump to the definition of the word under your cursor.
     --  This is where a variable was first declared, or where a function is defined, etc.
     --  To jump back, press <C-t>.
     map('<leader>cd', require('telescope.builtin').lsp_definitions, 'Goto [C]ode [D]efinition')
 ...
 { -- Highlight, edit, and navigate code
  ...
  opts = {
   ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'dart', 'json' },
